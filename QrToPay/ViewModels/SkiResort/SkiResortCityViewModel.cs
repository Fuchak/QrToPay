...
public partial class SkiResortCityViewModel : ViewModelBase
{
    ...
    public SkiResortCityViewModel(CityService cityService, AppState appState, CacheService cacheService)
    {
    ...
    public async Task LoadCitiesAsync(int serviceType)
    {
        ...
        {
            IsBusy = true;
            var cacheKey = CacheKeyHelper.GetCacheKey(AppDataConst.SkiResortCache);
